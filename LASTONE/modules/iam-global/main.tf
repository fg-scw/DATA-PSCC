...
#-------------------------------------------------------------------------------
# IAM API Keys - IMPORTANT: default_project_id is required for Object Storage
#-------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------
# IAM Policies - Admin access (FULL ORG ACCESS + explicit project access)
#-------------------------------------------------------------------------------
...
# Explicit project-level access for admin (needed for Object Storage)
...
#-------------------------------------------------------------------------------
# IAM Policies - Evaluators access (Zone 2 + Livrables + Team Projects)
#-------------------------------------------------------------------------------
...
resource "scaleway_iam_policy" "evaluators_teams" {
  ...
  organization_id = var.organization_id
  group_id        = scaleway_iam_group.evaluators.id
  description     = "Full read access to all team projects (instances, storage, etc)"
...
#-------------------------------------------------------------------------------
# IAM Application & API Key for Evaluators (for portal and CLI access)
#-------------------------------------------------------------------------------
...
# Add evaluator application to the evaluator group
...
#-------------------------------------------------------------------------------
# IAM Policies - Data Providers access (RW on admin project buckets)
#-------------------------------------------------------------------------------
